...
window.ORAL = { SCHWERPUNKTE: [
  ...
  },
  {
    ...
    "musterantwort": "Beide Verfahren liefern dieselben Ziffern, greifen die Zahl aber von entgegengesetzten Enden an: Die Zerlegung nach der größten Potenz bestimmt zuerst die höchste Ziffer a_m (wie viele b^m passen hinein), die fortgesetzte Division bestimmt zuerst die niedrigste Ziffer a_0 als Rest. Die Divisionsreste von unten gelesen entsprechen genau den Koeffizienten der Potenzdarstellung. Je größer die Basis b, desto mehr Werte fasst jede Stelle (b Ziffern) und desto weniger Stellen braucht eine feste Zahl; kleine Basen wie 2 liefern kurze Ziffernvorräte, aber lange Darstellungen (z. B. 34 = (100010)_2, aber 34 = (1021)_3 = 34 dezimal zweistellig).",
    "kriterien": [
  ...
  },
  {
    ...
    "musterantwort": "Zwei ganze Zahlen a und b heißen kongruent modulo m (geschrieben a ≡ b (mod m)), wenn sie beim Teilen durch m denselben Rest lassen, gleichbedeutend: wenn m die Differenz a − b teilt. Die Restklasse r̄ modulo m ist die Menge aller Zahlen mit demselben Rest r, also r̄ = {n | n = m·k + r}. Für m = 3 gibt es genau drei Restklassen: 0̄ = {0,3,6,…} (n = 3k), 1̄ = {1,4,7,…} (n = 3k+1) und 2̄ = {2,5,8,…} (n = 3k+2).",
    "kriterien": [
  ...
  },
  {
    ...
    "musterantwort": "Der Flächeninhalt ordnet jeder Figur eine nichtnegative Maßzahl zu. Ein Flächenmaß A erfüllt: A(∅)=0 und A(F)≥0 (Nichtnegativität); Additivität, d.h. wenn F und G keine inneren Punkte gemeinsam haben (F∩G=∅), dann A(F∪G)=A(F)+A(G); Kongruenzinvarianz (kongruente Figuren haben denselben Flächeninhalt); und die Normierung A(E)=1 für das Einheitsquadrat E. Das Einheitsquadrat legt als vereinbarte Maßeinheit e² fest, gegen die alle anderen Flächen gemessen werden.",
    "kriterien": [
  ...
  },
  {
    ...
    "musterantwort": "Ein reguläres Polygon (regelmäßiges n-Eck) ist ein Vieleck, dessen Seiten alle gleich lang sind und dessen Innenwinkel alle gleich groß sind. Eine Parkettierung der Ebene ist eine Menge kongruenter Figuren, die die zu allen Seiten unendlich gedachte Ebene überlappungsfrei (ohne Überlappung) und lückenlos ausfüllt, sodass man das Muster prinzipiell nach allen Seiten endlos fortsetzen kann.",
    "kriterien": [
  ...
  },
  {
    ...
    "kriterien": [
      "Nennt die drei Merkmale Ecken, Kanten, Flächen und die Dreidimensionalität/Volumen",
      "Definiert Polyeder korrekt über ebene Vielecke als Begrenzung",
      "Ordnet Beispiele richtig zu (Würfel/Quader/Pyramide = Polyeder; Zylinder/Kegel/Kugel = krummflächig)",
      "Verwendet präzise Fachsprache (Seitenflächen, Kanten, Ecken)"
    ],
  ...
  },
  {
    ...
    "musterantwort": "Ein Netz erhält man, indem man die sechs quadratischen Flächen des Würfels an einigen Kanten aufschneidet und den Körper in die Ebene abwickelt, sodass alle Flächen zusammenhängend und überlappungsfrei ausgebreitet liegen; umgekehrt lässt sich das Netz wieder zum Würfel zusammenfalten. Mathematisch sind Würfelnetze Hexominos (sechs zusammenhängende Quadrate). Berücksichtigt man Drehungen und Spiegelungen als gleich, gibt es genau 11 verschiedene Würfelnetze. Eine häufige Grundstruktur ist die 'Kreuz'- bzw. Reihenform mit vier Flächen in einer Reihe und je einer Fläche links und rechts.",
    "kriterien": [
